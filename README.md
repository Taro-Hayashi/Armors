...
- テスト用ファームウェア [armors_test.hex](https://github.com/Taro-Hayashi/Armors/releases/download/14.20/armors_test.hex)
...
- [armors_via.hex](https://github.com/Taro-Hayashi/Armors/releases/download/14.20/armors_via.hex)
